...
ImageBlock specifies the input type of the model and categoryblock indicates the output type. This tells fastai everything it needs to know about the model it is constructing.
